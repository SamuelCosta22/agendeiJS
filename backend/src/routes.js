...
// router.post("/admin/doctors", jwt.ValidateToken, controllerDoctor.InserirAdmin);
// router.put("/admin/doctors/:id_doctor", jwt.ValidateToken, controllerDoctor.EditarAdmin);
